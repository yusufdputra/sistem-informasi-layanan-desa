            ...
            <div class="row">
              ...
              <div class="row mb-3 mt-3">
                ...
                <div class="col-sm-5">
                  ...
                  <img src="<?php echo e(url('storage/'.$berita->foto_path)); ?>" alt="image" class="img-fluid rounded center" width="200" />
                </div>

                <?php endif; ?>
                <div class="col-sm-5">
                  <input type="file" accept="image/*" <?php if(!isset($berita)): ?> required <?php endif; ?> data-plugins="dropify" name="file_foto" data-max-file-size="1M" />
                </div>
              </div>
              <div class="form-group row">
