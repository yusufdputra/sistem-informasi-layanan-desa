                  ...
                  <div class="demo-box text-center p-3 mt-4">
                    <a href="#profil" class="text-dark">
                      <div class="position-relative demo-content">
                        <div class="demo-img">
                          <img src="storage/<?php echo e($value->foto_path); ?>" alt="" style="height: 200px !important;" class="img-fluid  rounded">
                        </div>
                      ...
                      <div class="mt-3">
                        ...
                        <p class="text-muted mb-1">Ketua <?php echo e($value->jabatan); ?></p>
                      </div>
                    </a>
                  </div>
                </div>
  ...
  <div class="container-fluid">
    ...
    <div class="row">
      <div class="col-xl-4 col-sm-6">
        <div class="services-box p-4 bg-white mt-4">
          <div class="services-img float-start me-4">
            <img src="<?php echo e(asset('adminto/landing/images/pkk.png')); ?>" alt="">
          </div>
          <h5>P K K</h5>
          <div class="overflow-hidden">
      ...
      <div class="col-xl-4 col-sm-6">
        <div class="services-box p-4 bg-white mt-4">
          <div class="services-img float-start me-4">
            <img src="<?php echo e(asset('adminto/landing/images/karang-taruna.png')); ?>" alt="">
          </div>
          <h5>Karang Taruna</h5>
          <div class="overflow-hidden">
      ...
      <div class="col-xl-4 col-sm-6">
        <div class="services-box p-4 bg-white mt-4">
          <div class="services-img float-start me-4">
            <img src="<?php echo e(asset('adminto/landing/images/icons/solarsystem.png')); ?>" alt="">
          </div>
          <h5>Keagamaan</h5>
          <div class="overflow-hidden">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="canvasLembagaPkk" aria-labelledby="offcanvasExampleLabel">
  ...
  <div class="offcanvas-body">
    <div class="">
      <div class="services-img col-12 ">
        <img src="<?php echo e(asset('adminto/landing/images/pkk.png')); ?>" class="img-fluid rounded" alt="">
      </div>
      <br>
      <div class="overflow-hidden">
        <p class="text-muted">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="canvasLembagaKT" aria-labelledby="offcanvasExampleLabel">
  ...
  <div class="offcanvas-body">
    <div class="">
      <div class="services-img col-12 ">
        <img src="<?php echo e(asset('adminto/landing/images/karang-taruna.png')); ?>" class="img-fluid rounded" alt="">
      </div>
      <br>
      <div class="overflow-hidden">
...
<div class="offcanvas offcanvas-start" tabindex="-1" id="canvasLembagaAgama" aria-labelledby="offcanvasExampleLabel">
  ...
  <div class="offcanvas-body">
    <div class="">
      <div class="services-img col-12 ">
        <!-- <img src="<?php echo e(asset('adminto/landing/images/icons/solarsystem.png')); ?>" class="img-fluid rounded" alt=""> -->
      </div> <br>
      <div class="overflow-hidden">
...
<?php echo $__env->make('landing.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SILADES\resources\views/landing/index.blade.php ENDPATH**/ ?>