            ...
            <div class="row">
              ...
              <div class="row mb-3 mt-3">
                ...
                <div class="col-sm-5">
                  ...
                  <img src="{{url('storage/'.$berita->foto_path)}}" alt="image" class="img-fluid rounded center" width="200" />
                </div>

                @endif
                <div class="col-sm-5">
                  <input type="file" accept="image/*" @if(!isset($berita)) required @endif data-plugins="dropify" name="file_foto" data-max-file-size="1M" />
                </div>
              </div>
              <div class="form-group row">
