 ...
 <!-- third party js ends -->
 <!-- Plugins js-->
 <script src="{{asset('adminto/libs/flatpickr/flatpickr.min.js')}}"></script>
 <script src="{{asset('adminto/libs/spectrum-colorpicker2/spectrum.min.js')}}"></script>
 <script src="{{asset('adminto/libs/clockpicker/bootstrap-clockpicker.min.js')}}"></script>
 <script src="{{asset('adminto/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js')}}"></script>

 <!-- Init js-->
 <script src="{{asset('adminto/js/pages/form-pickers.init.js')}}"></script>
 <!-- Plugins js -->
 ...
 <!-- Init js-->
 <script src="{{asset('adminto/js/pages/form-fileuploads.init.js')}}"></script>
 <!-- Datatables init -->
